...
export default async function Page({
  ...
  // ✅ NEW: afficher Enregistrer uniquement si on vient du profile (pas depuis home)
  const showSaveActions = from !== "home";

  // ✅ NEW: liens pour enregistrer dans saved / later (redirige vers profile)
  ...
  const key = id; // clé utilisée dans saved/later (doit correspondre à sessionKey côté profile si tu utilises sX)
