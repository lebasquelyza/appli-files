...
type PlanCard = {
  code: Plan;
  title: string;
  price: string;     // affichage (non utilisé directement, on recalcule depuis priceEUR)
    ...
    <div className="container" style={{ paddingTop:24, paddingBottom:32 }}>
      ...
      <header className="page-header" style={{ marginBottom:18 }}>
        <div>
          ...
          <p className="lead">Choisissez la formule qui vous convient et activez Coaching+ si besoin.</p>
      ...
      {!!searchParams?.success && (
        <div className="card" style={{ border:"1px solid rgba(16,185,129,.25)", background:"rgba(16,185,129,.08)", marginBottom:12 }}>
          ✅ Mise à jour enregistrée.
        </div>
      )}
      {!!searchParams?.error && (
        <div className="card" style={{ border:"1px solid rgba(239,68,68,.25)", background:"rgba(239,68,68,.08)", marginBottom:12 }}>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <article className="card">
            ...
            <div className="text-sm" style={{ color:"#6b7280", marginTop:8 }}>
              ...
              Total mensuel&nbsp;: <strong>{eur(total, " €")}</strong>
            </div>
          </article>
            ...
            return (
              <article
                ...
                style={{
                  ...
                  border: p.recommended ? "1px solid rgba(16,185,129,.35)" : undefined,
                  boxShadow: p.recommended ? "var(--shadow)" : undefined
                }}
              >
                {/* Rubans */}
                ...
                <div>
                  ...
                  <div style={{ marginTop:12 }}>
                    ...
                    <div className="text-sm" style={{ color:"#6b7280", marginTop:6 }}>
                      Total indicatif : <b>{eur(totalIndicatif)}</b>
                    </div>
                  </div>
                </div>
